...
<style>
    ...
    .top-header .dropdown-menu .dropdown-header {
        color: #999;
        font-size: 12px;
        font-weight: 600;
        padding: 8px 18px;
    ...
    .top-header .dropdown-menu .divider {
        margin: 6px 0;
    ...
    .has-second-marquee .left-sidebar {
        top: 146px;
    }
    ...
    .sidebar-menu>li.active>a .caret-icon {
        opacity: 1;
    }
    ...
    .sidebar-menu>li.open>a .caret-icon {
    ...
    .container-fluid>.row.clearfix:first-child {
        margin-top: 0;
    }
    ...
    body.sidebar-collapsed .left-sidebar .caret-icon {
        opacity: 0;
        visibility: hidden;
        width: 0;
        overflow: hidden;
    ...
    body.sidebar-collapsed .left-sidebar:not(:hover) .sidebar-submenu {
        display: none !important;
    }

    body.sidebar-collapsed .left-sidebar .sidebar-menu {
        padding: 12px 6px;
    }

    body.sidebar-collapsed .left-sidebar .sidebar-menu>li>a {
        padding: 14px 0;
    ...
    body.sidebar-collapsed .left-sidebar .sidebar-menu>li>a i.menu-icon {
        font-size: 17px;
        width: 64px;
        min-width: unset;
    }

    body.sidebar-collapsed .left-sidebar .sidebar-menu>li.active>a {
        width: 44px;
        margin: 0 auto;
    }
    ...
    body.sidebar-collapsed .left-sidebar:not(:hover) .sidebar-menu>li:hover>a::after {
    ...
    @media(max-width:991px) {
        ...
        .top-header-right .user-name-text {
            display: none;
        }
...
<body class="theme-blue {{ $broadcast ? 'has-second-marquee' : '' }}">
    <div class="page-loader-wrapper">
        <div class="loader">
            <?php
if (isset($general_setting)) { ?>
            <div class="m-t-30"><img src="{{ asset('public/uploads/' . $general_setting->preloader_photo) }}" width="48"
                    height="48" alt="{{$user_data->name}}"></div>
            <?php } else { ?>
            <div class="m-t-30"><img src="{{ asset('public/uploads/preload.gif') }}" width="48" height="48" alt="">
            </div>
            <?php } ?>
            <p>Please wait...</p>
        </div>
    ...
    <div id="wrapper">
        ...
        <div class="top-header">
            ...
            <div class="top-header-right">
                ...
                <a href="{{route('admin.payment.wallet')}}" class="wallet-pill">₹
                    {{ number_format($user_data->wallet_blc, 2) }}</a>
                <div class="dropdown">
        ...
        <aside class="left-sidebar" id="leftSidebar">
            <ul class="sidebar-menu">
                ...
                {{-- Orders --}}
                <li
                    class="{{ request()->routeIs('admin.order.all', 'admin.order.index', 'admin.order.return', 'admin.bulkorder.create', 'admin.ndr.ndr') ? 'active open' : '' }}">
                ...
                {{-- Operations --}}
                <li
                    class="{{ request()->routeIs('admin.order.shipped_order', 'admin.order.manifest', 'admin.payment.lostshipments') ? 'active open' : '' }}">
                ...
                {{-- Finance --}}
                <li
                    class="{{ request()->routeIs('admin.rate', 'admin.wallet_transaction', 'admin.invoices', 'admin.credit_notes', 'admin.order.remlist', 'admin.payment.walletreport', 'admin.weight') ? 'active open' : '' }}">
                    <a href="javascript:void(0)" class="sidebar-toggle" data-title="Finance">
                        <i class="fa fa-inr menu-icon"></i> <span class="menu-text">Finance</span>
                        <i class="fa fa-angle-right caret-icon"></i>
                    </a>
                    <ul class="sidebar-submenu">
                ...
                {{-- Courier --}}
                <li
                    class="{{ request()->routeIs('admin.integration.manage_courier', 'admin.integration.courier_serviceable', 'admin.integration.courier_priority') ? 'active open' : '' }}">
                ...
                {{-- Reports --}}
                <li
                    class="{{ request()->routeIs('admin.reports.mis', 'admin.reports.requestedreport', 'admin.order.shipment_report') ? 'active open' : '' }}">
    ...
    <a href="https://wa.me/919217856226" class="whatsapp-float" target="_blank">
        <i class="fa fa-whatsapp"></i>
    </a>

    <!-- Floating AWB Search -->
    <a href="javascript:void(0)" class="track-float" id="trackBtn" title="Track AWB"
        onclick="$('#trackPopup').fadeToggle(300)">
