                ...
                <div class="col-12">
                    <div class="card pt-30">
                        <div class="card-header">
                            ...
                            Add @endif
                                Broadcast<a data-action="collapse" class="float-right toggle-icon"><i
                                        class="fa fa-minus"></i></a></h5>
                        </div>
                        @if(isset($broadcast))
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <input class="form-control " type="date" name="from_date" required=""
                                            @if(isset($broadcast)) value="{{$broadcast->from_date}}" @else value="" @endif
                                            id="_1">
                                    </div>
                                    <div class="col-md-6">
                                        <input class="form-control " type="date" name="to_date" required=""
                                            @if(isset($broadcast)) value="{{$broadcast->to_date}}" @else value="" @endif
                                            id="_2">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select id="multiple-checkboxes" name="user_id[]" class="form-control" required
                                            multiple="multiple">
                                            @foreach($users as $user)
                                                                                    <option value='{{$user->id}}' <?php    if (isset($broadcast) && in_array($user->id, explode(',', $broadcast->user_id))) {
                                                    echo 'selected';
                                                } ?>>{{$user->name}}
                                                                                    </option>
                                            @endforeach
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" type="text" name="message" required
                                            @if(isset($broadcast)) value="{{$broadcast->message}}" @else value="" @endif>
                                    </div>
                                </div>
                            </div>
