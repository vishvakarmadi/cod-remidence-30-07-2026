                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05), 0 2px 4px -1px rgba(0, 0, 0, 0.02); overflow: hidden; border: 1px solid #e2e8f0;">
                    ...
                    <tr>
                        <td style="padding: 20px 40px 30px 40px; font-size: 15px; line-height: 1.6; color: #475569;">
                            ...
                            <p style="margin-bottom: 20px; font-size: 15px; color: #475569;">
                                We have successfully received your KYC update request on <strong>HyloShip</strong>.
                            </p>
                            ...
                            <div style="background-color: #f0f6f9; border: 1px solid #cbdde6; border-radius: 8px; padding: 20px; margin-bottom: 25px;">
                                <h3 style="margin-top: 0; margin-bottom: 10px; font-size: 16px; font-weight: 700; color: #07344E; display: flex; align-items: center;">
                                    <i class="fa fa-clock-o" style="margin-right: 8px; font-size: 18px; color: #07344E; vertical-align: middle;"></i>
                                    <span style="vertical-align: middle;">Verification Status: Under Review</span>
                                </h3>
                                <p style="margin: 0; font-size: 14.5px; color: #1a4d6b; line-height: 1.5;">
                                    Our verification team is reviewing the submitted details and documents (Aadhaar, PAN, GST, etc.). Your account status will be updated shortly once verification is complete.
                                </p>
                            </div>
                                ...
                                <tr>
                                    <td align="center" style="padding-bottom: 25px;">
                                        <a href="{{ $login_url }}" target="_blank" style="display: inline-block; padding: 12px 30px; background: linear-gradient(135deg, #07344E 0%, #175e87 100%); color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 15px; box-shadow: 0 4px 6px -1px rgba(7, 52, 78, 0.25); text-align: center; border: none; outline: none;">
                                            <i class="fa fa-tachometer" style="margin-right: 8px;"></i> Go to Dashboard
                                        </a>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td align="center" style="padding: 25px 40px; background-color: #f8fafc; font-size: 12px; color: #94a3b8; line-height: 1.6;">
                            <p style="margin: 0 0 5px 0;">This is an automated verification status email from HyloShip. Please do not reply directly to this message.</p>
                            <p style="margin: 0;">
