...
<script src="{{ asset('public/admin/assets/bundles/flotscripts.bundle.js') }}"></script> <!-- flot charts Plugin Js --> 
<script src="{{ asset('public/admin/assets/vendor/flot-charts/jquery.flot.selection.js') }}"></script>
...
<script src="{{ asset('public/admin/assets/vendor/bootstrap-colorpicker/js/bootstrap-colorpicker.js') }}"></script> <!-- Bootstrap Colorpicker Js --> 
<script src="{{ asset('public/admin/assets/vendor/jquery-inputmask/jquery.inputmask.bundle.js') }}"></script> <!-- Input Mask Plugin Js --> 
<script src="{{ asset('public/admin/assets/vendor/jquery.maskedinput/jquery.maskedinput.min.js') }}"></script>
<script src="{{ asset('public/admin/assets/vendor/multi-select/js/jquery.multi-select.js') }}"></script> <!-- Multi Select Plugin Js -->
...
<script src="{{ asset('public/admin/assets/vendor/bootstrap-tagsinput/bootstrap-tagsinput.js') }}"></script> <!-- Bootstrap Tags Input Plugin Js --> 
<!--<script src="{{ asset('public/admin/assets/vendor/nouislider/nouislider.js') }}"></script>  noUISlider Plugin Js --> 
    
<script src="{{ asset('public/admin/assets/bundles/morrisscripts.bundle.js') }}"></script>
<!--<script src="{{ asset('public/admin/assets/js/pages/forms/advanced-form-elements.js') }}"></script>-->
...
<script src="{{ asset('public/admin/assets/js/pages/ui/dialogs.js') }}"></script>
<script src="{{ asset('public/admin/assets/vendor/sweetalert/sweetalert.min.js') }}"></script>


<script src='{{ asset('public/admin/assets/bootstrap-tagsinput.min.js') }}'></script>
